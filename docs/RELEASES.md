...
| iStore | `re-ss-01-istore-v0.1.0-beta.5` | `京东云 AX1800 PRO（RE-SS-01）· iStoreOS Dashboard v0.1.0-beta.5` |
...
beta.5 当前构建使用以下 iStore 文件名：

```text
jdcloud-re-ss-01-libwrt-istore-v0.1.0-beta.5-squashfs-factory.bin
jdcloud-re-ss-01-libwrt-istore-v0.1.0-beta.5-squashfs-sysupgrade.bin
```
...
- iStoreOS Dashboard beta 永远是 Prerelease，且必须显式设置为非 Latest。当前测试线版本为 `0.1.0-beta.5`。
